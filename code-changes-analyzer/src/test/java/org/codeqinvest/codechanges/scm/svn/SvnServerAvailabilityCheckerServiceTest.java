...
public class SvnServerAvailabilityCheckerServiceTest {

  private SvnServerAvailabilityCheckerService availabilityCheckerService;

  @Before
  public void setUp() {
    availabilityCheckerService = new SvnServerAvailabilityCheckerService();
  }
